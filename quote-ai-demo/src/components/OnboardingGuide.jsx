...
const STEPS = [
  {
    title: '上传供应商报价单',
    body: '拖拽或点击上传 2–8 份 XLSX 文件，单份不超过 10 MB。系统会自动解析表格内容。',
  },
  {
    title: '一键比价',
    body: '上传完成后点击这里。系统自动对齐项目号、标最低价、检测漏报和量级异常，并给出精炼双语采购建议。',
  },
  {
    title: '精简双语报告',
    body: '比价结果出来后点这里。用 Flash 模型生成表格化中英报告：排名、价差、规格问题、下一步。',
  },
  {
    title: '导出报告',
    body: '报告生成后可导出 Excel（多 sheet 对比表），或直接打印 PDF。',
  },
]
